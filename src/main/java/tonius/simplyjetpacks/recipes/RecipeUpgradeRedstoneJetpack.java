...
public class RecipeUpgradeRedstoneJetpack implements IRecipe {
    ...
    public boolean matches(InventoryCrafting inventorycrafting, World world) {
        ...
        ItemStack slotStack;
        ItemStack capacitorNeeded = GameRegistry.findItemStack("ThermalExpansion", "capacitorResonant", 1);
        for(int i = 0; i < inventorycrafting.getSizeInventory(); i++) {
            ...
            switch(i) {
                ...
                case 3:
                case 5:
                    if(slotStack == null || OreDictionary.getOreName(OreDictionary.getOreID(slotStack)) != "ingotEnderium") {
                        return false;
                    }
                    break;
                case 1:
                ...
                case 4:
                    ...
                    if(slotStack.getItem() == SimplyJetpacks.jetpackTier3) {
                    ...
                    break;
                case 7:
                    if(slotStack == null || (slotStack.getItem() != SimplyJetpacks.metaItem1 && slotStack.getItemDamage() != 3)) {
                        return false;
                    }
                    break;
                case 6:
        ...
        // get result item
        result = new ItemStack(SimplyJetpacks.jetpackTier4);
        // calculate energy
