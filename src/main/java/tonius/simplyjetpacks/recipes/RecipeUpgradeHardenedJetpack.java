...
public class RecipeUpgradeHardenedJetpack implements IRecipe {
    ...
    public boolean matches(InventoryCrafting inventorycrafting, World world) {
        ...
        ItemStack slotStack;
        ItemStack capacitorNeeded = GameRegistry.findItemStack("ThermalExpansion", "capacitorReinforced", 1);
        for(int i = 0; i < inventorycrafting.getSizeInventory(); i++) {
            ...
            switch(i) {
                ...
                case 3:
                case 5:
                    if(slotStack == null || OreDictionary.getOreName(OreDictionary.getOreID(slotStack)) != "ingotElectrum") {
                        return false;
                    }
                    break;
                case 1:
                ...
                case 4:
                    ...
                    if(slotStack.getItem() == SimplyJetpacks.jetpackTier2) {
                    ...
                    break;
                case 7:
                    if(slotStack == null || (slotStack.getItem() != SimplyJetpacks.metaItem1 && slotStack.getItemDamage() != 2)) {
                        return false;
                    }
                    break;
                case 6:
        ...
        // get result item
        result = new ItemStack(SimplyJetpacks.jetpackTier3);
        // calculate energy
