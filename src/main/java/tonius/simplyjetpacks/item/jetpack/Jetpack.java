...
public class Jetpack {
    ...
    public static void reconstructJetpacks() {
        ...
        new JetpackEnergetic(5, 5, SJConfig.energeticEnchantable, EnumRarity.epic, SJConfig.energeticEnergyCapacity, SJConfig.energeticEnergyPerTick, SJConfig.energeticSpeedVertical, SJConfig.energeticAccelVertical, (float) SJConfig.energeticSpeedSideways, SJConfig.energeticSpeedVerticalHover, SJConfig.energeticSpeedVerticalHoverSlow, SJConfig.energeticEmergencyHoverMode, SJConfig.energeticArmorDisplay, SJConfig.energeticArmorAbsorption, SJConfig.energeticArmorEnergyPerHit);
